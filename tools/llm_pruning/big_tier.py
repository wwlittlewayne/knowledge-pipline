...
class Config:
    ...
    # Multi-domain mixing: list of {name, weight, split?, subset?} dicts.
    # When non-empty this OVERRIDES recover_dataset. weight is the share of
    # recover_samples drawn from that source. Use local .jsonl paths for
